            ...
            <div class="container-fluid">
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        include '../koneksi.php';
                        $no = 1;
                        $tampil = mysqli_query($conn, "SELECT kode_brg, nama_brg FROM tb_barang WHERE jumlah_brg = 0";
                        if ($result->num_rows > 0) {
                            // Menampilkan laporan stok barang habis
                            echo "Laporan Stok Barang Habis:<br><br>";
                        
                            while ($row = $result->fetch_assoc()) {
                                echo "Kode Barang: " . $row['kode_brg'] . "<br>";
                                echo "Nama Barang: " . $row['nama_brg'] . "<br>";
                                echo "<br>";
                            }
                        } else {
                            echo "<tr>";
