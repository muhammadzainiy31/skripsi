                                ...
                                <div class="basic-form">
                                 ...
                                 <div class="form-group">
                                      <h4 <label for="keterangan"> Keterangan </label>
                                         <input type="date" class="form-control input-default " name="keterangan" class="form-control col-md-9" placeholder="Masukkan Password">
                                     </div>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        $input = "INSERT INTO tb_driver VALUES ('','$nik_driver', '$tanggal_servis', '$keterangan',  '$jabatan', '$sim', '$alamat_driver'
        )";
