                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="ty_armada">Tyepe Armada</label></h4>
                                            <input type="text" class="form-control input-default" name="ty_armada" id="ty_armada" readonly>
                                        </div>

                                        <script>
                                            // Fungsi untuk melakukan autofill pada ty_armada dan alamat_cust
                                            function autofill() {
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    ...
                                                    echo "document.getElementById('ty_armada').value = '" . $hasil['ty_armada'] . "';";
