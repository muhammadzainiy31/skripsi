                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                            <h4><label for="armada">Armada</label></h4>
                                            <select name="armada" id="armada" class="form-control" required>
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    echo '<option value="' . $hasil['armada'] . '">' . $hasil['armada'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="type_armada">Tanggal Servis</label>
                                            <input type="date" class="form-control input-default" name="type_armada" placeholder="Masukkan Tanggal Servis">
                                        </div>
