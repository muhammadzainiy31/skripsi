    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
            ...
            FROM tb_armada
            INNER JOIN riwayat_servis ON tb_armada.no_plat = riwayat_servis.plat");
                    ...
                    if (mysqli_num_rows($tampil) > 0) {
                        while ($hasil = mysqli_fetch_array($tampil)) {
                            echo '<tr align="center">
                                    <td>' . $no++ . '</td>
                                    <td>' . $hasil['id_servis'] . '</td>
                                    <td>' . $hasil['no_plat'] . '</td>
                                    <td>' . $hasil['type_armada'] . '</td>
                                    <td>' . $hasil['tanggal_servis'] . '</td>
                                    <td>' . $hasil['keterangan'] . '</td>
                                    <td>' . $hasil['estimasi'] . '</td>
                                    <td>' . $hasil['biaya'] . '</td>
                                </tr>';
                        }
                    } else {
