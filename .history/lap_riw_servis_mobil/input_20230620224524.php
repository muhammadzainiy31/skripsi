                                ...
                                <div class="basic-form">
                                 ...
                                 <div class="form-group">
                                      <h4 <label for="tanggal_servis"> Tanggal Servis </label>
                                         <input type="date" class="form-control input-default " name="tanggal_servis" class="form-control col-md-9" placeholder="Masukkan Nama">
                                     </div>

                                 <div class="form-group">
                                      <h4 <label for="keterangan"> Keterangan </label>
                                         <input type="text" class="form-control input-default " name="keterangan" class="form-control col-md-9" placeholder="Masukkan Password">
                                     </div>

                              <div class="form-group">
                                              <h4 <label for="biaya">Biaya</label>
                                       <input type="text" class="form-control input-default " name="biaya" class="form-control col-md-9" placeholder="Masukkan biaya">
                                   </div>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        $biaya = $_POST['biaya']; 
        $input = "INSERT INTO riwayat_servis VALUES ('','$type_armada', '$tanggal_servis', '$keterangan',  '$biaya', '$sim', '$alamat_driver'
        )";
        mysqli_query($conn, $input ); 
            echo "<div align='center'><h5> Silahkan Tunggu, Data Sedang Disimpan....</h5></div>";
            echo "<meta http-equiv='refresh' content='1;url=http://localhost/RDO/lap_/index.php'>";
      }
