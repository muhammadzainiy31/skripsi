                                ...
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select name="id" id="id" class="form-control" required>
                                                ...
                                                <?php
                                                include "../koneksi.php";
                                                $ambilData = mysqli_query($conn, "SELECT * FROM tb_id") or die(mysqli_error($conn));
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    echo '<option value="' . $hasil['id'] . '">' . $hasil['id'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
...
if (isset($_POST['simpan'])) {
    ...
    $biaya = $_POST['biaya'];
    $input = "INSERT INTO riwayat_servis VALUES ('','$type_id', '$tanggal_servis', '$keterangan', '$estimasi', '$biaya')";
