            ...
            <div class="card-body">
              ...
              <br>
					<div class="input-group search-area ml-auto d-inline-flex">
						<input type="text" id="searchInput" class="form-control" placeholder="Search here" onkeyup="searchData()">
    ...
    <script>
        function searchData() {
            ...
            for (i = 0; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[2]; // Mengubah indeks kolom pencarian menjadi 2
