                                ...
                                <div class="basic-form">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="rute" value="BJB" <?php if($hasil['rute'] == 'BJB') echo 'checked'; ?>> BJB<br>
                                            <input type="radio" name="rute" value="BJM" <?php if($hasil['rute'] == 'BJM') echo 'checked'; ?>> BJM<br>
                                            <input type="radio" name="rute" value="LUAR KOTA" <?php if($hasil['rute'] == 'LUAR KOTA') echo 'checked'; ?>> LUAR KOTA<br>
                                        </div>
