...
<?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        $rute = $_POST['rute'];
        mysqli_query($conn, "UPDATE tb_customer SET id_cust='$id_cust', nama_cust='$nama_cust', no_telpon='$no_telpon', alamat_cust='$alamat_cust', alamat_cust='$alamat_cust', alamat_cust='$alamat_cust'
