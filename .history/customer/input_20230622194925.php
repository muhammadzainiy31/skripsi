                        ...
                        <div class="card">
                            <div class="card-header">
                             ...
                             <div class="card-body">
                              ...
                              <div class="form-group">
                                              <h4 <label for="rute"> kelurahan</label>
                                       <input type="text" class="form-control input-default " name="kelurahan" class="form-control col-md-9" placeholder="Masukkan Alamat">
                                   </div

                                     <div class="form-group">
                                             <h4 <label for="rute"  id="rute"> TYPE ARMADA </label>
                                            <br>
                                            <h4 <label><input type="radio" name="rute" value="HINO"> HINO</label>
                                            <h4 <label><input type="radio" name="rute" value="TAYO"> TAYO</label>
                                            <h4 <label><input type="radio" name="rute" value="KUDA"> KUDA</label>  
                                         </div>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        $input = "INSERT INTO tb_customer VALUES (' ', '$nama_cust', '$no_telpon', '$alamat_cust'
        )";
