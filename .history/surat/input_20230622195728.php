...
<body>
    ...
    ***********************************-->
                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        <h4><label for="kelurahnan">Alamat</label></h4>
                                        <input type="text" class="form-control input-default" name="kelurahnan" id="kelurahnan" readonly>
                                    </div>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $input = "INSERT INTO tb_surat VALUES ('', '$nm_cust', '$no_telpon', '$alamat_cust')";
