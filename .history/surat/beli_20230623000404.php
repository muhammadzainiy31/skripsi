                                ...
                                <div class="basic-form">
                                    <form method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control input-default" name="jmlh[]" placeholder="Masukkan Jumlah Barang" multiple>
                                        </div>
                                        <div class="form-group">
...
if (isset($_POST['simpan'])) {
    ...
    // Memproses setiap barang yang dimasukkan
    for ($i = 0; $i < count($kode_brg); $i++) {
        $input = "INSERT INTO tb_surat VALUES (' ',' ',' ',' ','" . $kode_brg[$i] . "','" . $nm_brng[$i] . "','" . $jmlh[$i] . "','" . $tanggal_kirim . "')";
