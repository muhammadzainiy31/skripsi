...
if (isset($_POST['simpan'])) {
    ...
    $rute = $_POST['rute'];
    $input = "INSERT INTO tb_surat (id_surat, nm_cust, no_telpon, alamat_cust, kelurahan, rute) VALUES ('$id_surat, $nm_cust', '$no_telpon', '$alamat_cust', '$kelurahan', '$rute', '$kode', '$qty', '$tanggal_kirim')";
