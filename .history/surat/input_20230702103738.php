...
if (isset($_POST['simpan'])) {
    ...
    $input = "INSERT INTO tb_surat (nm_cust, no_telpon, alamat_cust, kelurahan, rute, kode_brg, nm_brng, qty, tanggal_kirim) VALUES ('$nm_cust', '$no_telpon', '$alamat_cust', '$kelurahan', '$rute', '$kode', '$nmbrg', '$qty', '$tanggal_kirim')";
