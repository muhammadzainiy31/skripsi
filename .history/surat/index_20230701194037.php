                ...
                <div class="card-body">
                    ...
                    <div class="scroll-horizontal">
                        <table class="table table-bordered">
                            ...
                            include '../koneksi.php';
                            $no = 1;
                            $tampil = mysqli_query($conn, "SELECT tb_surat.id_surat, tb_surat.nm_cust, tb_surat.no_telpon, tb_surat.alamat_cust, tb_surat.kelurahan, tb_surat.rute,
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="edit.php?id_surat=<?php echo $hasil['id_surat']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-edit"></i></a>
