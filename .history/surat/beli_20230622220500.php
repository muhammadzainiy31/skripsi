...
<body>
    ...
    ***********************************-->
                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        <h4><label for="tanggal_kirim">Jumlah Barang</label></h4>
                                        <input type="number" class="form-control input-default" name="tanggal_kirim" placeholder="Masukkan Jumlah Barang">
                                    </div>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $input = "INSERT INTO tb_surat VALUES ('', '$pembelian')";
