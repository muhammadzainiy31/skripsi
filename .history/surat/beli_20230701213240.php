                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="namabrg">Nama Barang</label></h4>
                                            <input type="text area" class="form-control input-default" name="namabrg[]" id="namabrg" readonly>
                                        </div>
                                        <script>
                                            // Fungsi untuk melakukan autofill pada namabrg
                                            function autofillBrg() {
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    ...
                                                    echo "document.getElementById('namabrg').value += '" . $hasil['nama_brg'] . " | ';";
                                                    echo "}";
                                                }
                                                ?>
                                            }
                                        ...
                                        <div class="mt-4"></div>
                                        <button class="btn btn-primary mr-2" name="simpan">Beli</button> <!-- Mengubah label tombol menjadi "Beli" -->
