...
if (isset($_POST['simpan'])) {
    ...
    $rute = $_POST['nmbrg'];
    $rute = $_POST['qty'];
    $rute = $_POST['tanggal_kirim'];
    $input = "INSERT INTO tb_surat (nm_cust, no_telpon, alamat_cust, kelurahan, rute) VALUES ('$nm_cust', '$no_telpon', '$alamat_cust', '$kelurahan', '$rute', '$kode, '$nmbrg, '$qty', '$tanggal_kirim')";
