                ...
                <div class="card-body">
                    ...
                    <div class="scroll-horizontal">
                        <table class="table table-bordered">
                            ...
                            include '../koneksi.php';
                            $no = 1;
                            $tampil = mysqli_query($conn, "SELECT s.id_surat, s.nm_cust, s.no_telpon, s.alamat_cust, s.kelurahan, s.rute, s.id_pembelian, s.Barang, s.qty, s.Harga, s.tgl_beli, s.tgl_kirim, p.nama_pelanggan, p.alamat_pelanggan
                            FROM surat s
                            JOIN pembelian p ON s.id_pembelian = p.id_pembelian;");
