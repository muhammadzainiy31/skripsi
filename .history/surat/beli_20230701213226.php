                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="nama">Nama Barang</label></h4>
                                            <input type="text area" class="form-control input-default" name="nama[]" id="nama" readonly>
                                        </div>
                                        <script>
                                            // Fungsi untuk melakukan autofill pada nama
                                            function autofillBrg() {
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    ...
                                                    echo "document.getElementById('nama').value += '" . $hasil['nama_brg'] . " | ';";
                                                    echo "}";
                                                }
                                                ?>
                                            }
