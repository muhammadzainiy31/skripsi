...
<body>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <script>
                                            // Fungsi untuk melakukan autofill pada tlpn dan alamat_cust
                                            function autofill() {
    ...
    if (isset($_POST['simpan'])) {
        ...
        $rute = $_POST['rute'];
        $input = "INSERT INTO tb_surat (cust, tlpn, alamat_cust, kelurahan, rute) VALUES ('$cust', '$tlpn', '$alamat_cust', '$kelurahan', '$rute')";
