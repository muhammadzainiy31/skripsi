                                ...
                                <div class="basic-form">
                                    <form method="POST" action="" enctype="multipart/form-data">
                                            ...
                                            <h4>
                                                ...
                                                <select name="kode_brg[]" id="kode_brg" class="form-control" required multiple>
                                                    ...
                                                    while ($hasil = mysqli_fetch_array($ambilData)) {
                                                        echo '<option value="' . $hasil['kode_brg'] . '|' . $hasil['nama_brg'] . '">' .
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text area" class="form-control input-default" name="nm_brng[]" id="nm_brng" readonly>
                                        </div>
                                        <script>
                                            // Fungsi untuk melakukan autofill pada nm_brng
                                            function autofillBrg() {
                                                var kode_brg = document.getElementById("kode_brg").value;
                                                var kode = kode_brg.split('|')[0];
                                                var namabrg = kode_brg.split('|')[1];
                                                document.getElementById('nm_brng').value = namabrg;
                                            }
