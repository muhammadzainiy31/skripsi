...
<body>
    ...
    ***********************************-->
                             ...
                             <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control input-default" name="tanggal_kirim" placeholder="Masukkan Jumlah Barang">
                                    </div>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $input = "INSERT INTO tb_surat VALUES (' ','$kode_brg','$nm_brng','$jmlh','$tanggal_kirim')";

        
        echo "<div align='center'><h5> Silahkan Tunggu, Data Sedang Disimpan....</h5></div>";
        echo "<meta http-equiv='refresh' content='1;url=http://localhost/RDO/custo/index.php'>";
    }
    ?>
