                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="nmbrg">Nama Barang</label></h4>
                                            <input type="text" class="form-control input-default" name="nmbrg" id="nmbrg" readonly>
                                        </div>
...
if (isset($_POST['simpan'])) {
    ...
    $input = "INSERT INTO tb_surat (nm_cust, no_telpon, alamat_cust, kelurahan, rute, kode, nmbrg, qty, tanggal_kirim) VALUES ('$nm_cust', '$no_telpon', '$alamat_cust', '$kelurahan', '$rute', '$kode', '$nmbrg', '$qty', '$tanggal_kirim')";
