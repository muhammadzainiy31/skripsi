                    ...
                    <table class="table table-bordered">
                        ...
                        if (mysqli_num_rows($tampil) > 0) {
                            while ($hasil = mysqli_fetch_array($tampil)) {
                                $no_plat = $hasil['no_plat'];
                                $query_riwayat = "SELECT estimasi_selesai FROM riwayat_servis WHERE no_plat='$no_plat' ORDER BY id DESC LIMIT 1";
                        ...
                        ?>
                                <tr align="center">
                                    ...
                                    <td><?php echo $riwayat['estimasi_selesai'] ?></td>
                                    <td>
                                        <div class="d-flex">
