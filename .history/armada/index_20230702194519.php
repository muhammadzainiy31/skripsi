            ...
            <div class="container-fluid">
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        include '../koneksi.php';
                        $no = 1;
                        $tampil = mysqli_query($conn, "SELECT tb_armada.no_plat, tb_armada.type_armada, tb_armada.tahun, riwayat_servis.estimasi
                        FROM tb_armada
                        RIGHT JOIN riwayat_servis
                        ON tb_armada.no_plat = riwayat_sevis.no_plat"; ORDER BY id DESC ");
                        ...
                        ?>
                                <tr align="center">
                                    ...
                                    <td><?php echo $riwayat['estimasi'] ?></td>
                                    <td>
                                        <div class="d-flex">
