            ...
            <div class="container-fluid">
                <div class="card-body">
                    ...
                    if (isset($_POST['filter'])) {
                        ...
                        $query = "SELECT tb_armada.no_plat, tb_armada.type_armada, tb_armada.tahun, riwayat_servis.selesai AS estimasi
                                  FROM tb_armada
                ...
                <table class="table table-bordered">
                    ...
                    <?php
                    $no = 1;
                    $tampil = mysqli_query($conn, "SELECT tb_armada.no_plat, tb_armada.type_armada, tb_armada.tahun, riwayat_servis.estimasi AS estimasi
                                                    FROM tb_armada
