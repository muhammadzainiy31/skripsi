...
if (!isset($_SESSION["login"]) || $_SESSION["level"] != 2) {
    // Jika tidak ada sesi login atau level pengguna bukan 2, redirect ke halaman login atau halaman lain yang sesuai
    header("Location: login.php");
    exit; // Hentikan eksekusi kode selanjutnya
}

// Jika pengguna memiliki sesi login dan level 2, lanjutkan eksekusi kode pada halaman ini
?>

<!-- Kode HTML dan tampilan halaman index user -->
                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control input-default " name="no_plat" class="form-control col-md-9" placeholder="Masukkan Nomor Polisi/Plat" autofocus required>
                                     </div>
                              ...
                              <div class="form-group">
                                              <h4 <label for="tahun"> TAHUN </label>
                                       <input type="number" class="form-control input-default " name="tahun" class="form-control col-md-9" placeholder="Masukkan Tahun Armada">
                                   </div>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        $tahun = $_POST['tahun'];
        $input = "INSERT INTO tb_armada VALUES ('','$no_plat', '$type_armada', '$tahun'
        )";
