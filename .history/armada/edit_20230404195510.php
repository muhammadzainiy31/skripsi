                             ...
                             <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control input-default " name="no_plat"  id="no_plat" value="<?php echo $hasil['no_plat']?>"
                                     ...
                                     <div class="form-group">
                                             <h4 <label for="type_armada"  > TYPE ARMADA </label>
                                            <br>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        $tahun = $_POST['tahun'];
        mysqli_query($conn, "UPDATE tb_armada SET no_plat='$no_plat', type_armada='$type_armada', tahun='$tahun' 
        WHERE no_plat='$id'")or die (mysqli_error($conn));
