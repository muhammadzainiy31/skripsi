...
$result_barang = mysqli_query($conn, "SELECT B.*, K.nm_kategori, U.nm_ukuran FROM tbl_barang B, tbl_kategori K, tbl_ukuran U WHERE B.id_kategori = K.id_kategori AND B.id_ukuran = U.id_ukuran ORDER BY B.id_barang DESC");
?>
    ...
    <?php include "../theme-sidebar.php" ?>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            include'../koneksi.php';
            $no =1;
            $tampil = mysqli_query ($conn, "SELECT * FROM tb_armada");
