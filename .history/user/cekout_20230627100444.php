                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="status">TYPE ARMADA</label></h4>
                                            <div>
                                                <label><input type="radio" name="status" value="HINO"> HINO</label>
                                            </div>
                                            <div>
                                                <label><input type="radio" name="status" value="TAYO"> TAYO</label>
                                            </div>
                                            <div>
                                                <label><input type="radio" name="status" value="KUDA"> KUDA</label>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="keterangan"> KETERANGAN </label>
                                            <input type="text" class="form-control input-default" name="keterangan" placeholder="Masukkan Nomor Telpon">
                                        </div>
