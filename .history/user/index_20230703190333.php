...
if (isset($_POST["login"])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if (password_verify($password, $hasil["password"])) {
            ...
            $today = date('Y-m-d');
            $query_surat = "SELECT * FROM tb_surat WHERE nik_driver = '$nik' AND tanggal_kirim = '$today'";
                ...
                <div class="card-body">
                    ...
                    <div class="scroll-horizontal">
                        <table class="table table-bordered">
                            ...
                            include '../koneksi.php';
                            $no = 1;
                            $tampil = mysqli_query($conn, "SELECT * FROM tb_pengirim WHERE nik_driver = '$nik' AND tanggal_kirim = '$today");
