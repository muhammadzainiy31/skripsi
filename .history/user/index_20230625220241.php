        ...
        <div class="content-body">
            ...
            <div class="card-body">
              ...
              <br>
                ...
                <br> <br> <div class="scroll-horizontal">
...
<td>
    <div class="d-flex">
        <a href="edit.php?id_surat=<?php echo $hasil['id_surat']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1">
            <i class="fa fa-door-open"></i> <!-- Mengganti kelas ikon menjadi "fa fa-door-open" untuk pintu masuk -->
        </a>
        <a href="hapus.php?id_surat=<?php echo $hasil['id_surat']; ?>" class="btn btn-danger shadow btn-xs sharp">
            <i class="fa fa-sign-out-alt"></i> <!-- Mengganti kelas ikon menjadi "fa fa-sign-out-alt" untuk keluar -->
        </a>
    </div>
</td>
