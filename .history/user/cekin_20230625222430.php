...
$ambilData = mysqli_query($conn, "SELECT * FROM tb_surat_jalan WHERE id_surat='$id_surat'");
...
if (isset($_POST['submit'])) {
    ...
    $no_plat = $_POST['no_plat'];
    $nik_driver = $_POST['nik_driver'];
    $input = "INSERT INTO tb_pengirim VALUES ('id_pengiriman', '$id_surat', '$nm_cust', '$no_telpon', '$alamat_cust', '$kelurahan', '$rute', '$pembelian', '$no_plat', '$nik_driver')";
