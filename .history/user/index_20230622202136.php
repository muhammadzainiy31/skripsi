    ...
    <?php include "theme-sidebar.php" ?>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            include'../koneksi.php';
            $no =1;
            $tampil = mysqli_query($conn, "SELECT * FROM tb_surat_jalan");
            ...
            ?>
                ...
                <td>
                    ...
                    <div class="d-flex">
                    <a href="input.php?id_surat=<?php echo $hasil['id_surat'];?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                  ...
                  <td><?php echo $hasil ['kode_brng']?> </td>
