...
if (isset($_POST['submit'])) {
    ...
    $input = "INSERT INTO tb_pengirim (id_pengiriman, nm_cust, no_telpon, alamat_cust, kelurahan, rute, pembelian, no_plat, nik_driver) VALUES ('$id_pengiriman', '$nm_cust', '$no_telpon', '$alamat_cust', '$kelurahan', '$rute', '$pembelian', '$no_plat', '$nik_driver')";
                                ...
                                <div class="basic-form">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <h4><label for="jam_tiba"> JAM TIBA </label></h4>
                                            <input type="time" class="form-control input-default" name="jam_tiba" placeholder="Masukkan Jam Tiba">
                                        </div>

                                        <div class="form-group">
                                        <h4><label for="km_tiba"> KM BERANGKAT </label></h4>
                                            <input type="text" class="form-control input-default" name="km_tiba" placeholder="Masukkan KM Berangkat">
                                        </div>
...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tb_pengiriman (id_pengiriman, id_surat, dari, tujuan, jam_tiba, km_tiba, status, keterangan) VALUES ('$id_pengiriman', '$id_surat', '$dari', '$tujuan', '$jam_tiba', '$km_tiba', '$status', '$keterangan')";
    $result = mysqli_query($conn, $query);

    if ($result) {
        echo "<script>alert('Data berhasil ditambahkan.');</script>";
        echo "<script>window.location.href='http://localhost/RDO/lap_surat_jalan/index.php';</script>";
    } else {
