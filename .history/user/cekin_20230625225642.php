                                ...
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default" name="jam_berangkat" placeholder="Masukkan Nomor Telpon">
                                        </div>

                                        <div class="form-group">
                                            <label for="km_bera"> KM BERANGKAT </label>
                                            <input type="text" class="form-control input-default" name="km_bera" placeholder="Masukkan Nomor Telpon">
                                        </div>
