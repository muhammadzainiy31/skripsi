...
if (isset($_POST['submit'])) {
    ...
    $input = "INSERT INTO tb_pengirim (id_pengiriman, id_surat, dari, tujuan, jam_tiba, km_berangkat, status, keterangan) VALUES ('$id_pengiriman', '$id_surat', '$dari', '$tujuan', '$jam_tiba', '$km_berangkat', '$status', '$keterangan')";
