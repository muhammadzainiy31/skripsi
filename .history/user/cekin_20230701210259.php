...
if (isset($_POST['submit'])) {
    ...
    echo "<meta http-equiv='refresh' content='1;url=http://localhost/user/lap_surat_jalan/index.php'>";
    exit();
}
?>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                        <h4><label for="jam_berangkat"> JAM BERANGKAT </label></h4></h4>
                                            <input type="time" class="form-control input-default" name="jam_berangkat" placeholder="Masukkan Jam Berangkat">
                                        </div>
