        ...
        <ul class="metismenu" id="menu">
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="../surat/index.php">Surat</a></li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="../lap_pengiriman/index.php">Pengiriman</a></li>
                    <li><a href="../lap_surat_jalan/index.php">Surat Jalan</a></li>
                    <li><a href="../lap_serah_terima/index.php">Serah terima</a></li>
                    ...
                    <li><a href="../lap_detail_armada/index.php">Detail Armada</a></li>
                    ...
                    <li><a href="../lap_riw_servis/index.php">Riwayat Servis Armada</a></li>
                    <li><a href="../lap_barang_habis/index.php">Barang Habis</a></li>
                    <li><a href="../lap_barang_tersedia/index.php">Barang Tersedia</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="./rdo.php">Berangkat</a></li>
                </ul>
            </li>
        </ul>
