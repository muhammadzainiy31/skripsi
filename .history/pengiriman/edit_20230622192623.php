...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        $input = "INSERT INTO tb_report VALUES (' ', '$surat_id', '$nm_cust', '$tujuan', '$jam_berangkat', '$km_berangkat', '$jam_tiba', '$km_tiba', '$jumlah_km', '$status','$keterangan'
        )";
