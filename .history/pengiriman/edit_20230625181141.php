                             ...
                             <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="n">NO PLAT</label></h4>
                                            <select name="n" id="n" class="form-control" required>
                                                <option value="">-PILIH-</option>
                                                <?php
                                                include "../koneksi.php";
                                                $ambilData = mysqli_query($conn, "SELECT * FROM tb_armada") or die(mysqli_error($conn));
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    echo '<option value="' . $hasil['n'] . '">' . $hasil['n'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <script>
                                            ...
                                            // Panggil fungsi autofill saat combo box berubah
                                            document.getElementById("n").addEventListener("change", autofill);
                                        </script>
