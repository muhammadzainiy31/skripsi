                             ...
                             <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="type_">Telpon</label></h4>
                                            <input type="text" class="form-control input-default" name="type_" id="type_" readonly>
                                        </div>

                                        <script>
                                            // Fungsi untuk melakukan autofill pada type_ dan alamat_cust
                                            function autofill() {
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    echo "if (no_plat === '" . $hasil['no_plat'] . "') {";
                                                        echo "document.getElementById('type_').value = '" . $hasil['type_'] . "';";
                                                }
                                                ?>
                                            }
