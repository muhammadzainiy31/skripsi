                             ...
                             <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="type_aramda">TINGKAT type_aramda</label></h4>
                                            <input type="text" class="form-control input-default" name="type_aramda" id="type_aramda" value="<?php echo $hasil['type_aramda']; ?>">
                                        </div>
