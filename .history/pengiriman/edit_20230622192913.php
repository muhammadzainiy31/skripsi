                             ...
                             <div class="card-body">
                              ...
                              <div class="form-group">
                                     ...
                                     <div class="form-group">
                                                 ...
                                                 <input type="text" class="form-control input-default " name="alamat_cust" class="form-control col-md-9" placeholder="Masukkan Jam">
                                     </div>

                                          <div class="form-group">
                                        <h4 <label for="pembelian"> Pembelian</label>
                                        <input type="text" class="form-control input-default " name="pembelian" class="form-control col-md-9" placeholder="Masukkan KM BERANGKAT">
                                      </div>
