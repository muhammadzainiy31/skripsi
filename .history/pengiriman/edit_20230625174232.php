                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"  class="form-control input-default " name="id_surat" class="form-control col-md-9" placeholder="Masukkan Id Surat" autofocus required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control input-default" name="nm_cust" id="nm_cust" value="<?php echo $hasil['nm_cust']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <h4><label for="alamat_cust">TINGKAT alamat_cust</label></h4>
                                        ...
                                        <div class="form-group">
                                            <h4><label for="rute">TINGKAT rute</label></h4>
                                            <input type="text" class="form-control input-default" name="rute" id="rute" value="<?php echo $hasil['rute']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <h4><label for="pembeliamn">TINGKAT pembeliamn</label></h4>
                                            <input type="text" class="form-control input-default" name="pembeliamn" id="pembeliamn" value="<?php echo $hasil['pembeliamn']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <h4><label for="tanggal_kirim">TINGKAT tanggal_</label></h4>
                                            <input type="text" class="form-control input-default" name="tanggal_" id="tanggal_" value="<?php echo $hasil['tanggal_']; ?>">
                                        </div>
...
<?php
    ...
    if(isset($_POST['alamat_custpan']))
    {
        ...
        $input = "INSERT INTO tb_report VALUES (' ', '$id_surat', '$nm_cust', '$no_telpon', '$alamat_cust', '$pembelian', '$jam_tiba', '$km_tiba', '$jumlah_km', '$status','$keterangan'
        )";
