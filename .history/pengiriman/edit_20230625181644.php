                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="nik_driver" id="nik_driver" class="form-control" required>
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    echo '<option value="' . $hasil['nik_driver'] . '">' . $hasil['nik_driver'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <script>
                                            ...
                                            function autofill() {
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    echo "if (nik_driver === '" . $hasil['nik_driver'] . "') {";
                                                        echo "document.getElementById('nama').value = '" . $hasil['alamat_cust'] . "';";
                                                }
                                                ?>
                                            }
                                            ...
                                            // Panggil fungsi autofill saat combo box berubah
                                            document.getElementById("nik_driver").addEventListener("change", autofill);
                                        </script>

                                        

                                        <div class="form-group">
                                            <h4><label for="nama_driver">Alamat</label></h4>
                                        ...
                                        <div class="mt-4"></div>
                                        <button class="btn btn-primary mr-2" name="nama_driverpan" >alamat_custpan</button>
