                             ...
                             <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"  class="form-control input-default " name="id_surat" class="form-control col-md-9" placeholder="Masukkan Id Surat" autofocus required>
                                        ...
                                        <div class="form-group">
                                            <h4><label for="pembeliam">TINGKAT pembeliam</label></h4>
                                            <input type="text" class="form-control input-default" name="pembeliam" id="pembeliam" value="<?php echo $hasil['pembeliam']; ?>">
                                        </div>
