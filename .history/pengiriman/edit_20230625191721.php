                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="nik_driver" id="nik_driver" class="form-control" required>
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    echo '<option value="' . $hasil['nik_driver'] . '">' .  $hasil['nik_driver'] . ' - ' . $hasil['nama_driver'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
...
if (isset($_POST['submit'])) {
    ...
    $input = "INSERT INTO tb_pengirim VALUES (' ', '$id_surat', '$nm_cust', '$no_telpon', '$alamat_cust', '$alamat_cust', '$alamat_cust', '$pembelian', '$no_plat', '$nik_driver', '$jumlah_km', '$status','$keterangan')";
