...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tb_pengirim (id_surat, nm_cust, no_telpon, alamat_cust, kelurahan, rute, pembelian, no_plat,type_armada,nik_driver, nama_driver) 
              VALUES ('$id_surat', '$nm_cust', '$no_telpon', '$alamat_cust', '$kelurahan', '$rute', '$pembelian', '$no_plat','$type_armada', '$nik_driver','$nama_driver')";
