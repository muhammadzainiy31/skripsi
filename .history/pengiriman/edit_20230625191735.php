...
if (isset($_POST['submit'])) {
    ...
    $input = "INSERT INTO tb_pengirim VALUES (' ', '$id_surat', '$nm_cust', '$no_telpon', '$alamat_cust', '$kelurahan', '$alamat_cust', '$pembelian', '$no_plat', '$nik_driver', '$jumlah_km', '$status','$keterangan')";
