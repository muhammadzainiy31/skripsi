                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                              ...
                              <div class="form-group">
                                     ...
                                     <div class="form-group">
                                                 <h4 <label for="alamat_cust"> JAM BERANGKAT </label>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        $input = "INSERT INTO tb_report VALUES (' ', '$surat_id', '$nm_cust', '$no_telpon', '$alamat_cust', '$km_berangkat', '$jam_tiba', '$km_tiba', '$jumlah_km', '$status','$keterangan'
        )";
