...
<div class="form-group">
    ...
    <input type="text" class="form-control input-default" name="tanggal_kirim" id="tanggal_kirim" value="<?php echo $hasil['tanggal_kirim']; ?>" readonly>
                                        ...
                                        <div class="form-group">
                                            <h4><label for="type_armada">NAMA DRIVER</label></h4>
                                        ...
                                        <script>
                                            ...
                                            function autofill() {
                                                ...
                                                var options = document.getElementById("nik_driver").options;
                                                for (var i = 0; i < options.length; i++) {
                                                    if (options[i].value === no_plat) {
                                                        document.getElementById('nama_driver').value = options[i].getAttribute('data-nama');
                                                        break;
                                                    }
                                                }
                                            }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="nik_driver" id="nik_driver" class="form-control" required>
                                                ...
                                                while ($hasil = mysqli_fetch_array($ambilData)) {
                                                    echo '<option value="' . $hasil['nik_driver'] . '" data-nama="' . $hasil['nama_driver'] . '">' . $hasil['nik_driver'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
