                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <h4><label for="beralku">TANGGAL LAHIR</label></h4>
                                            <input type="date" class="form-control input-default" name="beralku" id="beralku" value="<?php echo $hasil['tanggal_lahir']; ?>">
                                        </div>
