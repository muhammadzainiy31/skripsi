...
$tampil = mysqli_query($conn, "SELECT * FROM tb_driver WHERE nama_driver LIKE '%$searchValue%' ORDER BY nik_driver DESC");
?>

<!-- ... (kode HTML yang ada sebelum tabel) ... -->

<div class="input-group search-area ml-auto d-inline-flex">
    <input type="text" class="form-control" placeholder="Search here" id="searchInput" value="<?php echo $searchValue; ?>">
...
<br>
<br>
<!-- ... (kode HTML yang ada setelah input search) ... -->

<table class="table table-bordered" id="dataTable">
    <!-- ... (kode HTML yang ada sebelum header tabel) ... -->
</table>

<!-- ... (kode HTML yang ada setelah tabel) ... -->
...
<body>
    ...
    <script>
        function searchTable() {
            ...
            for (i = 0; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[1]; // Adjust the column index for the desired search
                if (td) {
                    txtValue = td.textContent || td.innerText;
                    if (txtValue.toUpperCase().indexOf(filter) > -1) {
                        tr[i].style.display = "";
