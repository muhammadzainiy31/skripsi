...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($conn, "UPDATE tb_driver SET nik_driver='$nik_driver', nama_driver='$nama_driver', tanggal_lahir='$tanggal_lahir', jabatan='$jabatan', sim='$sim',sim='$sim', alamat_driver='$alamat_driver' 
