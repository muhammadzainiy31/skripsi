                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                    <tr align="center">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="edit.php?nik_driver=<?php echo $hasil['id']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                <a href="hapus.php?id=<?php echo $hasil['nik_driver']; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                            <?php }
