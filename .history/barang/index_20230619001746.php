        ...
        <div class="content-body">
            ...
            ?>
                <tr align="center" >
                  ...
                  <td><?php echo $hasil ['deper']?></td>
                  <td><?php echo $hasil ['jumlah_brg']?> </td>
                  <td>
                    
                  <div class="d-flex">
						<a href="edit.php?kode_brg=<?php echo $hasil['kode_brg'];?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
						<a href="hapus.php?kode_brg=<?php echo $hasil['kode_brg'];?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
					</div>
                  </td>
                </tr>
                <?php }} else{ ?>
