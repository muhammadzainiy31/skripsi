                                ...
                                <div class="basic-form">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="kode_brg">ID BARANG</label>
                                            <input type="text" class="form-control input-default" name="kode_brg" placeholder="Masukkan ID Barang" required>
                                        </div>
                                        ...
                                        <button type="submit" name="tambah_jumlah" class="btn btn-primary">Tambah Jumlah</button>
