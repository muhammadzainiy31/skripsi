                                ...
                                <div class="basic-form">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <br>
                                            <h4 <label><input type="radio" name="dep" value="KAMAR TIDUR"> KAMAR TIDUR</label>
                                            <h4 <label><input type="radio" name="dep" value="DAPUR DAN RUANG MAKAN"> DAPUR DAN RUANG MAKAN</label>
                                            <h4 <label><input type="radio" name="dep" value="RUANG TAMU"> RUANG TAMU</label> 
                                            <h4 <label><input type="radio" name="dep" value="RUANG KERJA"> RUANG KERJA</label>  
                                         </div>
