                                ...
                                <div class="basic-form">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <br>
                                            <h4 <label><input type="radio" name="departemen" value="KAMAR TIDUR"> KAMAR TIDUR</label>
                                            <h4 <label><input type="radio" name="departemen" value="DAPUR DAN RUANG MAKAN"> DAPUR DAN RUANG MAKAN</label>
                                            <h4 <label><input type="radio" name="departemen" value="RUANG TAMU"> RUANG TAMU</label> 
                                            <h4 <label><input type="radio" name="departemen" value="RUANG KERJA"> RUANG KERJA</label>  
                                         </div>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        $input = "INSERT INTO tb_barang VALUES ('$kode_brg', '$nama_brg', '$depertemen', '$jumlah_brg'
        )";
