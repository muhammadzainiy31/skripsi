        ...
        <div class="content-body">
            ...
            ?>
                <tr align="center" >
                  ...
                  <div class="d-flex">
                  ?no_plat=<?php echo $hasil['no_plat'];?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                <a href="edit.php" class="btn btn-primary">Tambah Stok</a></div>
                  </td>
                </tr>
                <?php }} else{ ?>
                <tr>
