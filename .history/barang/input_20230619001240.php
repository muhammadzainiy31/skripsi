                                ...
                                <div class="basic-form">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <br>
                                            <h4 <label><input type="radio" name="DE" value="KAMAR TIDUR"> KAMAR TIDUR</label>
                                            <h4 <label><input type="radio" name="DE" value="DAPUR DAN RUANG MAKAN"> DAPUR DAN RUANG MAKAN</label>
                                            <h4 <label><input type="radio" name="DE" value="RUANG TAMU"> RUANG TAMU</label> 
                                            <h4 <label><input type="radio" name="DE" value="RUANG KERJA"> RUANG KERJA</label>  
                                         </div>
