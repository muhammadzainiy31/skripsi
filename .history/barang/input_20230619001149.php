                                ...
                                <div class="basic-form">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <br>
                                            <h4 <label><input type="radio" name="type_armada" value="HINO"> KAMAR TIDUR</label>
                                            <h4 <label><input type="radio" name="type_armada" value="TAYO"> DAPUR DAN RUANG MAKAN</label>
                                            <h4 <label><input type="radio" name="type_armada" value="KUDA"> RUANG</label> 
