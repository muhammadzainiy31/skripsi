                                ...
                                <div class="basic-form">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <h4 <label><input type="radio" name="type_armada" value="RUANG TAMU"> RUANG TAMU</label> 
                                            <h4 <label><input type="radio" name="type_armada" value="RUANG KERJA"> RUANG KERJA</label>  
                                         </div>
